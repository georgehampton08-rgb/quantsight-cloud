"""
H2H Data Generation - Batch 5 (Players 356-445)
==============================================
"""
import sys
import os
...
logging.basicConfig(level=logging.INFO, format='[BATCH5] %(message)s')
...
def main():
    logger.info(f"🚀 Starting BATCH {BATCH_ID} (players {START_IDX}-{END_IDX})")
